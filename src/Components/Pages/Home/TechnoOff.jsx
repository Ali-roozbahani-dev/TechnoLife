            ...
            <div className="technoOff lg:px-3 lg:rounded-[20px] lg:border yekan-regular">
                <div className="relative">
                    <div className="TechnoOff-header lg:rounded-lg yekan-bold">
                        ...
                        <div><span className="text-[15px] md:text-[18px]">نمایش همه</span><GrFormPrevious  className="inline-block text-xl"/></div>
                    </div>                    
                    <button className="technoOff-prev-btn right-3"><FaChevronRight className="mx-auto font-bold"/></button>
                    <button className="technoOff-next-btn left-3"><FaChevronLeft className="mx-auto font-bold"/></button>
                    <Swiper
                        modules={[Navigation]}
                        navigation={{
